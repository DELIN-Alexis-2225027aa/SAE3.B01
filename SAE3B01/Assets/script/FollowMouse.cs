...
public class FollowMouse : MonoBehaviour
{
    ...
    // Stocker la différence entre les coordonnées de la souris avant et aprés le lancement du programme
    ...
    void Update()
    {
        ...
        // Déplacer l'image avec une vitesse basée sur le déplacement vertical de la souris multipliée par le facteur d'échelle
